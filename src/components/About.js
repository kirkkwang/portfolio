    ...
    return (
      <section className="About" id="About">
        ...
        <p>
          ...
          automation and leaving the busy work to machines and freeing up time
          for people to do things only people can do. My love for coding started
          with good old fashion batch scripting and quickly moved over to
          Python. Now I'm learning JavaScript and Ruby and loving every moment
          of it.
        </p>
        <img
